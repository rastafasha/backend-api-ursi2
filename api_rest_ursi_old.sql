...
-- Tiempo de generación: 07-03-2026 a las 14:14:09
...
CREATE TABLE `cronologiacursos` (
  ...
  `modo_eng` varchar(255) DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `title_eng` varchar(255) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `description_eng` text DEFAULT NULL,
  `fecha` varchar(255) DEFAULT NULL,
  `fecha_eng` varchar(255) DEFAULT NULL,
  `hora` varchar(255) DEFAULT NULL,
  `hora_eng` varchar(255) DEFAULT NULL,
  `clases` varchar(255) DEFAULT NULL,
  `clases_eng` varchar(255) DEFAULT NULL,
  `proyecto` varchar(255) DEFAULT NULL,
  `proyecto_eng` varchar(255) DEFAULT NULL,
  `duracion` varchar(255) DEFAULT NULL,
  `duracion_eng` varchar(255) DEFAULT NULL,
...
CREATE TABLE `cursos` (
  ...
  `adicional_eng` text DEFAULT NULL,
