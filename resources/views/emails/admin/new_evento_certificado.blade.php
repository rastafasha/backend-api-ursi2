                                                                                                                ...
                                                                                                                <td class="btn-20 btn-secondary c-white l-white"
                                                                                                                    ...
                                                                                                                    <multiline>
                                                                                                                        <a href="#"
                                                                                                                            ...
                                                                                                                            <span
                                                                                                                                class="link c-white"
                                                                                                                                style="text-decoration:none; color:#ffffff;">Nombre del Evento:
                                                                                                                                #{{$evento->name}}</span>
                                                                                                                        </a>
                                                                                                                    </multiline>
                                                                                                                </td>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td class="text-16"
                                                                                                                                ...
                                                                                                                                <multiline>
                                                                                                                                    ...
                                                                                                                                    <br />
                                                                                                                                    {{$evento->client->name . ' ' . $evento->client->surname}}
                                                                                                                                    <br />
                                                                                                                                    <!-- Chicago, IL 60301 -->
                                                                                                                                </multiline>
                                                                                                                            </td>
                                                                                                                    ...
                                                                                                                    <table
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td class="text-16"
                                                                                                                                style="font-size:16px; line-height:20px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important;">
                                                                                                                                <multiline>
                                                                                                                                    <em><strong>Evento:</strong>
                                                                                                                                        {{$evento->name}}</em>
                                                                                                                                    <br>
                                                                                                                                    <em><strong>información:</strong>
                                                                                                                                        {{$evento->description }}</em>
                                                                                                                                    <br>
                                                                                                                                    <em><strong>Fecha:</strong>
                                                                                                                                        <br>
                                                                                                                                        {{$evento->fecha_inicio}}</em>
                                                                                                                                    <br>
                                                                                                                                    <em><strong>asistió el día:</strong>
                                                                                                                                        {{$evento->created_at}}</em>
                                                                                                                                </multiline>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                                        ...
                                                                                                                                        <td class="btn-20 btn-secondary c-white l-white"
                                                                                                                                            ...
                                                                                                                                            <multiline>
                                                                                                                                                <a href="#"
                                                                                                                                                    ...
                                                                                                                                                    {{-- <span
                                                                                                                                                        class="link c-white"
                                                                                                                                                        style="text-decoration:none; color:#ffffff;">Costo del evento:
                                                                                                                                                        ${{$evento->amount}}</span> --}}
                                                                                                                                                </a>
                                                                                                                                            </multiline>
                                                                                                                                        </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="img" width="117"
                                                                                ...
                                                                                <a href="https://malcolmcordova.com/"
                                                                                    target="_blank"><img
                                                                                        src="https://malcolmcordova.com/Firma_files/logotipo.png"
                                                                                        width="150" height="43"
                                                                                        editable="true" border="0"
                                                                                        alt="" /></a>
                                                                            </td>
